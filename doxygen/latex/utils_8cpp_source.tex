...
\begin{DoxyCode}{0}
\DoxyCodeLine{00001\ }
\DoxyCodeLine{00014\ vector<vector<string>>\ parseCSV(\textcolor{keyword}{const}\ \textcolor{keywordtype}{string}\&\ filename)\ \{}
...
\DoxyCodeLine{00070\ \}}
\DoxyCodeLine{00071\ }
\DoxyCodeLine{00085\ \textcolor{keywordtype}{string}\ bigOrSmall(\textcolor{keywordtype}{string}\ dataset=\textcolor{stringliteral}{"{}"{}})\{}
\DoxyCodeLine{00086\ }
...
\DoxyCodeLine{00122\ \textcolor{keywordtype}{string}\ populate\_graph(Graph<T>\ \&g,\ \textcolor{keywordtype}{string}\ dataset=\textcolor{stringliteral}{"{}"{}})\{}
\DoxyCodeLine{00123\ }
\DoxyCodeLine{00124\ \ \ \ \ cout\ <<\ \textcolor{stringliteral}{"{}parsing\ data..."{}}\ <<\ endl\ <<\ endl;}
\DoxyCodeLine{00125\ }
\DoxyCodeLine{00126\ \ \ \ \ \textcolor{keywordflow}{if}(dataset.empty())\ dataset\ =\ bigOrSmall();}
\DoxyCodeLine{00127\ }
\DoxyCodeLine{00128\ \ \ \ \ \textcolor{keyword}{auto}\ cities\ =\ parseCSV(\textcolor{stringliteral}{"{}./"{}}\ +\ dataset\ +\ \textcolor{stringliteral}{"{}/Cities.csv"{}});}
\DoxyCodeLine{00129\ \ \ \ \ \textcolor{keyword}{auto}\ stations\ =\ parseCSV(\textcolor{stringliteral}{"{}./"{}}\ +\ dataset\ +\ \textcolor{stringliteral}{"{}/Stations.csv"{}});}
\DoxyCodeLine{00130\ \ \ \ \ \textcolor{keyword}{auto}\ reservoirs\ =\ parseCSV(\textcolor{stringliteral}{"{}./"{}}\ +\ dataset\ +\ \textcolor{stringliteral}{"{}/Reservoirs.csv"{}});}
\DoxyCodeLine{00131\ \ \ \ \ \textcolor{keyword}{auto}\ pipes\ =\ parseCSV(\textcolor{stringliteral}{"{}./"{}}\ +\ dataset\ +\ \textcolor{stringliteral}{"{}/Pipes.csv"{}});}
\DoxyCodeLine{00132\ \ \ \ \ }
...
\DoxyCodeLine{00137\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}(!g.addVertex(city))\ cout\ <<\ \textcolor{stringliteral}{"{}\(\backslash\)t-\/\ failed\ to\ add\ "{}}\ <<\ city-\/>getInfo()\ <<\ endl;}
\DoxyCodeLine{00138\ \ \ \ \ \}}
\DoxyCodeLine{00139\ \ \ \ \ }
...
\DoxyCodeLine{00144\ }
\DoxyCodeLine{00145\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}(!g.addVertex(station))\ cout\ <<\ \textcolor{stringliteral}{"{}\(\backslash\)t-\/\ failed\ to\ add\ "{}}\ <<\ station-\/>getInfo()\ <<\ endl;}
\DoxyCodeLine{00146\ \ \ \ \ \}}
\DoxyCodeLine{00147\ }
...
\DoxyCodeLine{00152\ }
\DoxyCodeLine{00153\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}(!g.addVertex(reservoir))\ cout\ <<\ \textcolor{stringliteral}{"{}\(\backslash\)t-\/\ failed\ to\ add\ "{}}\ <<\ reservoir-\/>getInfo()\ <<\ endl;}
\DoxyCodeLine{00154\ \ \ \ \ \}}
\DoxyCodeLine{00155\ \ }
...
\DoxyCodeLine{00165\ }
\DoxyCodeLine{00166\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}(bidirectional)\ g.addBidirectionalEdge(source,\ destination,\ capacity);}
\DoxyCodeLine{00167\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{else}\ g.addEdge(source,\ destination,\ capacity);}
\DoxyCodeLine{00168\ \ \ \ \ \}\ \ \ }
\DoxyCodeLine{00169\ \ \ \ \ }
\DoxyCodeLine{00170\ \ \ \ \ \textcolor{comment}{//set\ flow\ of\ edges\ to\ zero}}
\DoxyCodeLine{00171\ \ \ \ \ \textcolor{keyword}{auto}\ verti\ =\ g.getVertexSet();}
...
\DoxyCodeLine{00181\ \}}
\DoxyCodeLine{00182\ }
\DoxyCodeLine{00194\ \textcolor{comment}{//print\ edges\ and\ corresponding\ flow}}
\DoxyCodeLine{00195\ \textcolor{keyword}{template}\ <\textcolor{keyword}{class}\ T>}
\DoxyCodeLine{00196\ \textcolor{keywordtype}{void}\ printGraph(Graph<T>\ \&g)\{}
\DoxyCodeLine{00197\ \ \ \ \ cout\ <<\ endl\ <<\ \textcolor{stringliteral}{"{}FINAL\ RESULT:\ "{}}\ <<\ endl\ <<\ endl;}
\DoxyCodeLine{00198\ \ \ \ \ \textcolor{keyword}{auto}\ verti\ =\ g.getVertexSet();}
\DoxyCodeLine{00199\ \ \ \ \ \textcolor{keywordflow}{for}(\textcolor{keyword}{auto}\ v:\ verti)\{}
\DoxyCodeLine{00200\ \ \ \ \ \ \ \ \ \textcolor{keyword}{auto}\ edges\ =\ v-\/>getAdj();}
\DoxyCodeLine{00201\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{for}(\textcolor{keyword}{auto}\ e:\ edges)\{}
\DoxyCodeLine{00202\ \ \ \ \ \ \ \ \ \ \ \ \ cout\ <<\ \textcolor{stringliteral}{"{}edge:\ "{}}\ <<\ e-\/>getOrig()-\/>getInfo()\ <<\ \textcolor{stringliteral}{"{}-\/"{}}\ <<\ e-\/>getDest()-\/>getInfo()\ <<\ \textcolor{stringliteral}{"{}\ \ \(\backslash\)tflow:\ "{}}\ <<\ e-\/>getFlow()\ <<\ \textcolor{stringliteral}{"{}/"{}}\ <<\ (e-\/>getWeight()\ ==\ 1000000000\ ?\ \textcolor{stringliteral}{"{}inf"{}}\ :\ to\_string((\textcolor{keywordtype}{int})e-\/>getWeight()))\ <<\ \ endl;}
\DoxyCodeLine{00203\ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00204\ \ \ \ \ \}}
...
\DoxyCodeLine{00223\ \textcolor{keywordtype}{bool}\ validCity(Graph<T>\ \&g,\ \textcolor{keywordtype}{string}\ city)\{}
\DoxyCodeLine{00224\ \ \ \ \ \textcolor{keywordflow}{if}(city\ ==\ \textcolor{stringliteral}{"{}all"{}})\ \textcolor{keywordflow}{return}\ \textcolor{keyword}{true};}
\DoxyCodeLine{00225\ }
\DoxyCodeLine{00226\ \ \ \ \ \textcolor{keywordflow}{return}\ g.findVertex(city);}
\DoxyCodeLine{00227\ \}}
